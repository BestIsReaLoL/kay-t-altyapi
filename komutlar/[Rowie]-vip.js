...
let vip = '971473784169168968' //verilicek vip rolü
if(!["972539422014865508"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR")))//veren rol 
 ...
 member.roles.add(vip)
  let embed = new Discord.MessageEmbed()
   .setColor("2d3136")
  .setDescription(`${member} kişisi'ye artık <@&971473784169168968> Rolü Verildi .`)
  .setTimestamp()
  message.react('✅')
