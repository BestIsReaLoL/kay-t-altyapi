...
let regal = '971473784139837554' //verilicek alınacak reg rolü
if(!["971473784261443689"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
 ...
 member.roles.remove(regal)
  ...
  .setColor("2d3136")
  .setDescription(`${member} kişisi'den Artık <@&971473784139837554> Rolü Alınmıştır.`)
  .setTimestamp()
  message.react('✅')
